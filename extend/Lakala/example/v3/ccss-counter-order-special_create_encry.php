...
$api = new \Lakala\OpenAPISDK\V3\Api\LakalaApi($config, \Lakala\OpenAPISDK\V3\Api\EncryptMode::REQUEST);
...
try {
    $response = $api->tradeApi('/api/v3/ccss/counter/order/special_create_encry', $request);
