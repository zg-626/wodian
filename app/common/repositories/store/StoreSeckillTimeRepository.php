...
class StoreSeckillTimeRepository extends BaseRepository
{
    ...
    public function form(?int $id = null ,array $formData = [])
    {
        ...
        $form->setRule([
            ...
            Elm::frameImage('pic', '图片：', '/' . config('admin.admin_prefix') . '/setting/uploadPicture?field=pic&type=1')->width('1000px')->height('600px')->spin(0)->icon('el-icon-camera')->modal(['modal' => false])->props(['footer' => false]),
        ]);
