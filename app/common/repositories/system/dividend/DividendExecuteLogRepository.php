...
use app\common\dao\system\dividend\DividendExecuteLogDao;
...
/**
 * Class DividendExecuteLogRepository
 * @package app\common\repositories\system\dividend
 * @author xaboy
 * @day 2020/8/5
 * @mixin DividendExecuteLogDao
 */
class DividendExecuteLogRepository extends BaseRepository
{

    public function __construct(DividendExecuteLogDao $dao)
    {
        $this->dao = $dao;
    }
