...
class MerchantRepository extends BaseRepository
{
    ...
    public function lst(array $where, $page, $limit)
    {
        ...
        $list = $query->page($page, $limit)->setOption('field', [])
            ...
            ->field('sort,mer_id,mer_name,real_name,mer_phone,mer_address,mark,status,create_time,is_best,is_trader,type_id,category_id,copy_product_num,export_dump_num,is_margin,margin,ot_margin,mer_avatar,margin_remind_time,province_id,city_id,district_id,salesman_id,is_integral')->select();
    ...
    {
        $field = 'care_count,commission_rate,mer_state,mer_address,integral,is_trader,type_id,mer_id,mer_banner,mini_banner,mer_name, mark,mer_avatar,product_score,service_score,postage_score,sales,status,is_best,create_time,long,lat,is_margin,is_online';
        $where['status'] = 1;
        $where['mer_state'] = 1;
        $where['is_del'] = 0;
