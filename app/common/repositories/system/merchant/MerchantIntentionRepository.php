    ...
    public function updateStatus($id, $data)
    {
        ...
        if ($create == 1) {
            if ($intention['mer_lkl_id'] > 0) {
                $info = \app\common\model\system\merchant\MerchantEcLkl::where('id', $intention['mer_lkl_id'])->field('id,lkl_mer_cup_status')->find();
                if (!$info) {
        ...
        if ($create == 1) {
            ...
            $merData = [
                ...
                'mer_address' => $intention['address'],
                'mini_banner' => $intention['mer_banner'],
                'mer_banner' => $intention['mer_banner'],
                'status' => 1,
                'commission_switch' => 1,
                'is_audit' => 1,
