...
class MerchantIntention extends BaseController
{
    ...
    {
        $data = $this->request->params(['phone','salesman_id','is_online', 'mer_banner', 'mer_name', 'name', 'code', 'images', 'merchant_category_id', 'mer_type_id','commission_rate','inside','id_card']);
